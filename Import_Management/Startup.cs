...
using Import_Management.DbContexts;
using Import_Management.ErrorHandling;
using Import_Management.Helper;
using Import_Management.middleware;
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
           ...
           // app.UseCors();
            ...
            if (!env.IsProduction())
            {
                app.UseSwagger(c =>
                {
                    c.RouteTemplate = "Import_Management/swagger/{documentName}/swagger.json";
                });
 
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/Import_Management/swagger/v1/swagger.json", "Import_Management");
